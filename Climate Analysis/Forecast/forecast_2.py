...
# load the dataset
dataframe = pd.read_csv('D:\Blockchain\AgroChain Project\Climate Analysis\Forecast\data\spiKtm.csv', usecols=[7])
dataframe.dropna(subset = ["spi_3"], inplace=True)
dataframe.head()
plt.plot(dataframe)
...
scaler = MinMaxScaler(feature_range=(-1, 1)) #Also try QuantileTransformer
