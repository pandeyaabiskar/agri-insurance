...
<body>
<div id="app">
    <main class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="logo-src"><a class="navbar-brand" href="{{ url('/') }}" style="color: #2e9e93">
                        Agrochain
                    </a></div>
                                        ...
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                           class="p-0 btn">
                                            <img width="42" class="rounded-circle"
                                                 src="{{url('uploads/'.Auth::user()->filename)}}" alt="">
                                            <i class="fa fa-angle-down ml-2 opacity-8"></i>
                                        </a>
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                             class="dropdown-menu dropdown-menu-right ">
                                            <button type="button" tabindex="0" class="dropdown-item">Profile
                                            </button>

                                            @if(session('role') == 'admin')
                                            <h6 tabindex="-1" class="dropdown-header">ACTION</h6>
                                                <a type="button" tabindex="0" class="dropdown-item"
                                                   href="{{ route('crop.add') }}">>Add New Crop</a>
                                            @endif
        ...
        @if(Session::has('message'))
            <div class="alert alert-{{Session::get('class')}} alert-dismissible fade show" role="alert" style="top: 60px; z-index: 1000">
                {{ Session::get('message') }}
                ...
                <div class="scrollbar-sidebar">
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                <a href="{{route('home')}}"  class="@if(isset($dashboardactive)) {{$dashboardactive}} @endif">
                            ...
                            <li>
                                <a href="#" class="@if(isset($projectactive)) {{$projectactive}} @endif">
                                ...
                                <ul>
                                    <li>
                                        <a href="#">
                                            ...
                                            View Adopted Project
                                        </a>
                                    </li>
                                </ul>
                            </li>

                            <li class="app-sidebar__heading">User Controls</li>

                            <li>
                                <a href="{{route('profile')}}" class="@if(isset($profileactive)) {{$profileactive}} @endif">
                                    <i class="fas fa-user"></i>
                                    Profile
                                </a>
                            </li>
                            <li>
                                <a href="{{route('password.reset', auth::user()->id)}}" class="@if(isset($passwordactive)) {{$passwordactive}} @endif">
