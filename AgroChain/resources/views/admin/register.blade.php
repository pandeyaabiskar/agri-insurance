            ...
            <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>Crop Dashboard
                            <div class="page-title-subheading">Add New Crops for Farmers.
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-8">
                                        ...
                                        <strong>{{ $errors->first('name') }}</strong>
                                            ...
                                            <div class="form-group row">
                                                <label for="season" class="col-md-4 col-form-label text-md-right">Favourable
                                                    Season</label>

                                                <div class="col-md-8">
                                                    <input id="season" type="text"
                                                           class="form-control{{ $errors->has('season') ? ' is-invalid' : '' }}"
                                                           name="season" value="{{ old('season') }}"
                                                           placeholder="Eg. Monsoon">
                                        ...
                                        <strong>{{ $errors->first('season') }}</strong>
                                            ...
                                            <div class="form-group row">
                                                <label for="harvest" class="col-md-4 col-form-label text-md-right">Harvest
                                                    Days</label>

                                                <div class="col-md-8">
                                                    <input id="harvest" type="text"
                                                           class="form-control{{ $errors->has('harvest') ? ' is-invalid' : '' }}"
                                                           name="harvest" value="{{ old('harvest') }}"
