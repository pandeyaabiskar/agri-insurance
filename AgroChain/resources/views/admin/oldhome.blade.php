...
@section('content')
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="text-left">
                    <h3 class="my-4 text-left">Request for Profile Verification</h3>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-12 ml-auto">
                        <div class="card">
                            <div class="card-header">Farmer's List</div>
                                ...
                                @if(count($verificationProfiles) > 0)
                                    <table class="table" id="table">
                                        ...
                                        @foreach($verificationProfiles as $verificationProfile)
                                            <tr>
                                                <td>{{$verificationProfile->users->account}}</td>

                                                <td>{{$verificationProfile->users->name}}</td>
                                                <td>{{$verificationProfile->farm_name}}</td>
                                                <td>{{$verificationProfile->farm_location}}</td>
                                                <td>{{$verificationProfile->registration}}</td>
                                                <td>
